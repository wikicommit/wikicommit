...
// Vendored from github:quartz-community/explorer's tsup.config.ts: bundles
// *.inline.ts as minified browser JS text (rather than a normal ESM module)
// so QuartzComponent.afterDOMLoaded can embed it verbatim as an inline
