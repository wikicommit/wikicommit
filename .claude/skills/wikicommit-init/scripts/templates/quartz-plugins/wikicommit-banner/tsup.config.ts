...
export default defineConfig({
  ...
  // silently defeats every entry in SINGLETON_EXTERNALS (Issue #379: this
  // plugin previously used [/.*/], the same latent bug wikicommit-jsonld hit
  // in Issue #186 before it had a component with a value import to trip it).
