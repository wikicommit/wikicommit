...
//
//   - Most keys are plain labels ("Generated:", "Model:", "unknown"). A
//     clumsy translation is clumsy and nothing more.
//   - A minority carry claims — what this wiki does and does not vouch for,
//     what "read by a person" means, what a reader is being asked to
//     report. Several of those sentences exist specifically to keep this
//     wiki from overstating what it knows.
//
