...
// Issue #378: frontmatter.lang (ISO 639-1) must take priority over the
// site-wide cfg.locale (BCP 47) so each page's own language decides its
// captions, not the site's global default.
